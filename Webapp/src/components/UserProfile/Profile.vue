<template>
  <b-container fluid style="margin-top: 100px;">
          ...
          <b-col md="9" class="text-white">
            ...
            <b-row class="mt-3">
              <b-col class="opacity-text-8" md="12">
                ...
                <b-link v-for="site in user.social_media_sites" class="social-media-link text-white"
    ...
    <change-password-modal :type="type" v-bind:username="user.username" v-bind:userid="user.id"></change-password-modal>
