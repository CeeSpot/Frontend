<template>
    ...
    <b-row>
      ...
      <b-col cols="12"><b-form-input class="mb15" v-model="booking.name" type="text"></b-form-input></b-col>

      <b-col cols="12"><label>Email:</label></b-col>
      <b-col cols="12"><b-form-input class="mb15" v-model="booking.email" type="text"></b-form-input></b-col>

      <b-col cols="12"><label>Telefoon:</label></b-col>
      <b-col cols="12"><b-form-input class="mb15" v-model="booking.phone" type="text"></b-form-input></b-col>

      <b-col cols="12"><label>Datum:</label></b-col>
      <datetime class="mb15" type="date" input-class="form-control" placeholder="" format="dd-MM-yyyy" v-model="booking.date"></datetime>

      <b-col cols="12"><label>Start:</label></b-col>
      <datetime class="mb15" type="time" input-class="form-control" placeholder="" format="HH:mm" v-model="booking.start"></datetime>

      <b-col cols="12"><label>Eind:</label></b-col>
      <datetime class="mb15" type="time" input-class="form-control" placeholder="" format="HH:mm" v-model="booking.end"></datetime>


    <b-button class="float-right" v-on:click="addReservation">Opslaan</b-button>
    </b-row>
  </b-modal>
    </b-container>
</template>
